...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 请假管理 <span class="c-gray en">&gt;</span> 待销假 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">此页面只展示待销假假条。</span> </div>
    <div class="mt-20">
...
<script type="text/javascript">
    ...
    $(".table-sort").dataTable({
        ...
        "columns":[
            ...
            { 	data: 'id',
                ...
                width: '60',
                render: function ( data, type, row, meta ) {
                    return "<a title=\"销假\" onclick=\"leave_xj("+data+")\" class=\"ml-5\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6e1;</i></a>";
                }
            }
        ]
    });
    ...
    //审核通过
    function leave_xj(id) {
        layer.confirm('您确定销假吗?',function(){
            $.ajax({
                type: "POST",
                url: "/teacher/leave_dxj_success_ajax",
                data: {leaveId:id},
                dataType: "text",
                success: function(data){
                    if(data=="success"){
                        ...
                        layer.msg('销假错误!',{icon:5,time:1000});
                    }
                },
