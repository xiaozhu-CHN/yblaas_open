...
<article class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">注意：只能选择本学院的老师作为辅导员</span> </div>
    <div class="mt-20">
...
<script type="text/javascript">
    ...
    $(".table-sort").dataTable({
        ...
        "ajax":{
            url: '/teacher/user_eclass_teacher_ajax',
            dataSrc: '',
            type: 'GET',
            error:function() {
        ...
        "columns":[
            ...
            { 	data: 'teacher',
                ...
                render: function ( data, type, row, meta ) {
                    return "<a title=\"任命\" onclick=\"eclass_teacher_add('" + data + "')\" class=\"ml-5\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe603;</i></a>";
                }
            }
        ]
    });
    ...
    //任命
    function eclass_teacher_add(teacher) {
        layer.confirm('您确定任命吗?',function(){
            $.ajax({
                type: "POST",
                url: "/teacher/user_eclass_teacher_add_ajax",
                data: {eclassId:eclassId,teacherId:teacher},
                dataType: "text",
